...
def MebeV1():
    ...
    ''')
        ...
        for i in range(0, len(streckendaten)):
            ...
            while prüfung == 0:
                try:
                    rennpfad = 'Datenbank/Meisterschaften/' + str(eingabeA) + str(prüfziffer) + 'Rennergebnisse' + \
        ...
        while prüfung == 0:
            try:
                speicherpfad = 'Datenbank/Meisterschaften/' + str(eingabeA) + str(
        ...
        drucken(Rangliste)  # geht auch komplizierter, mit Textverarbeitung etc.//txt und html?
...
weiter=0
eingabetext=0
drucken("Klicke auf Weiter, um eine Eingabe zu bestätigen.")
